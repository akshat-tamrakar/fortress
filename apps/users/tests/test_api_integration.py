...
class TestUserDetailAPI:
    ...
    def test_get_user_success(self, mock_user_service, api_client, sample_user_data):
        ...
        url = reverse("users:user-detail", kwargs={"user_id": "123e4567-e89b-12d3-a456-426614174000"})
        api_client.force_authenticate(user=MagicMock(is_authenticated=True))
...
class TestUserDisableEnableAPI:
    ...
    @patch("apps.users.views.user_service")
    def test_disable_user_success(self, mock_user_service, api_client, sample_user_data):
        ...
        url = reverse("users:user-disable", kwargs={"user_id": "123e4567-e89b-12d3-a456-426614174000"})
        api_client.force_authenticate(user=MagicMock(is_authenticated=True))
    ...
    def test_enable_user_success(self, mock_user_service, api_client, sample_user_data):
        ...
        url = reverse("users:user-enable", kwargs={"user_id": "123e4567-e89b-12d3-a456-426614174000"})
        api_client.force_authenticate(user=MagicMock(is_authenticated=True))
...
class TestMeAPI:
    ...
    @patch("apps.users.views.user_service")
    def test_get_me_success(self, mock_user_service, api_client, sample_user_data, valid_access_token):
    ...
    @patch("apps.users.views.user_service")
    def test_update_me_success(self, mock_user_service, api_client, sample_user_data, valid_access_token):
...
class TestMFASetupAPI:
    ...
    @patch("apps.users.views.user_service")
    def test_mfa_setup_initiate(self, mock_user_service, api_client, valid_access_token):
